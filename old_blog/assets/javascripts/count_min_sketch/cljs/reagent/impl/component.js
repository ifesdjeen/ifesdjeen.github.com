...
reagent.impl.component.do_render = (function do_render(C){var _STAR_current_component_STAR_33843 = reagent.impl.component._STAR_current_component_STAR_;try{reagent.impl.component._STAR_current_component_STAR_ = C;
var f = (C[reagent.impl.component.cljs_render]);var _ = ((reagent.impl.util.clj_ifn_QMARK_.call(null,f))?null:(function(){throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol("util","clj-ifn?","util/clj-ifn?",-520791343,null),new cljs.core.Symbol(null,"f","f",-1640531425,null))))].join('')))})());var p = reagent.impl.util.js_props.call(null,C);var res = ((((C["componentFunction"]) == null))?f.call(null,C):(function (){var argv = (p[reagent.impl.util.cljs_argv]);var n = cljs.core.count.call(null,argv);var G__33844 = n;if(cljs.core._EQ_.call(null,5,G__33844))
{return f.call(null,cljs.core.nth.call(null,argv,1),cljs.core.nth.call(null,argv,2),cljs.core.nth.call(null,argv,3),cljs.core.nth.call(null,argv,4));
} else
{if(cljs.core._EQ_.call(null,4,G__33844))
{return f.call(null,cljs.core.nth.call(null,argv,1),cljs.core.nth.call(null,argv,2),cljs.core.nth.call(null,argv,3));
} else
{if(cljs.core._EQ_.call(null,3,G__33844))
{return f.call(null,cljs.core.nth.call(null,argv,1),cljs.core.nth.call(null,argv,2));
} else
{if(cljs.core._EQ_.call(null,2,G__33844))
{return f.call(null,cljs.core.nth.call(null,argv,1));
} else
{if(cljs.core._EQ_.call(null,1,G__33844))
{return f.call(null);
} else
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_33843;
}});
reagent.impl.component.custom_wrapper = (function custom_wrapper(key,f){var G__33846 = key;if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"componentWillUnmount","componentWillUnmount",4147620643),G__33846))
{return ((function (G__33846){
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"componentDidUpdate","componentDidUpdate",4103164189),G__33846))
{return ((function (G__33846){
return (function (oldprops){var C = this;var old_argv = (oldprops[reagent.impl.util.cljs_argv]);return f.call(null,C,old_argv);
});
;})(G__33846))
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"componentWillUpdate","componentWillUpdate",2086388618),G__33846))
{return ((function (G__33846){
return (function (nextprops){var C = this;var next_argv = (nextprops[reagent.impl.util.cljs_argv]);return f.call(null,C,next_argv);
});
;})(G__33846))
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"shouldComponentUpdate","shouldComponentUpdate",3193956709),G__33846))
{return ((function (G__33846){
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"componentWillReceiveProps","componentWillReceiveProps",2122862542),G__33846))
{return ((function (G__33846){
return (function (props){var C = this;return f.call(null,C,(props[reagent.impl.util.cljs_argv]));
});
;})(G__33846))
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"getInitialState","getInitialState",2219830677),G__33846))
{return ((function (G__33846){
return (function (){var C = this;return reagent.impl.component.set_state.call(null,C,f.call(null,C));
});
;})(G__33846))
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"getDefaultProps","getDefaultProps",1976256919),G__33846))
{if(false)
{return null;
} else
...
{return (function() { 
var G__33847__delegate = function (args){var C = this;return cljs.core.apply.call(null,f,C,args);
};
var G__33847 = function (var_args){
var args = null;if (arguments.length > 0) {
  args = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__33847__delegate.call(this,args);};
G__33847.cljs$lang$maxFixedArity = 0;
G__33847.cljs$lang$applyTo = (function (arglist__33848){
var args = cljs.core.seq(arglist__33848);
return G__33847__delegate(args);
});
...
{var G__33850 = f;(G__33850["__reactDontBind"] = true);
return G__33850;
} else
{return f;
}
...
reagent.impl.component.map_to_js = (function map_to_js(m){return cljs.core.reduce_kv.call(null,(function (o,k,v){var G__33852 = o;(G__33852[cljs.core.name.call(null,k)] = v);
return G__33852;
}),{},m);
});
...
return (function() { 
var G__33853__delegate = function (args){return as_component.call(null,cljs.core.apply.call(null,cljs.core.vector,res,args));
};
var G__33853 = function (var_args){
var args = null;if (arguments.length > 0) {
  args = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__33853__delegate.call(this,args);};
G__33853.cljs$lang$maxFixedArity = 0;
G__33853.cljs$lang$applyTo = (function (arglist__33854){
var args = cljs.core.seq(arglist__33854);
return G__33853__delegate(args);
});
