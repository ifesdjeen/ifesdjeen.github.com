...
{return (function() { 
var G__33855__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
var G__33855 = function (var_args){
var args = null;if (arguments.length > 0) {
  args = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__33855__delegate.call(this,args);};
G__33855.cljs$lang$maxFixedArity = 0;
G__33855.cljs$lang$applyTo = (function (arglist__33856){
var args = cljs.core.seq(arglist__33856);
return G__33855__delegate(args);
});
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__33858 = res;(G__33858[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__33858;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__33859){var vec__33861 = p__33859;var id = cljs.core.nth.call(null,vec__33861,0,null);var class$ = cljs.core.nth.call(null,vec__33861,1,null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_33862 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_33862 === "key")))
{(o[pname_33862] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__33865 = jsprops;(G__33865["defaultValue"] = value);
(G__33865["value"] = null);
(G__33865["onChange"] = ((function (G__33865,on_change,value){
return (function (p1__33863_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__33863_SHARP_);
});})(G__33865,on_change,value))
);
return G__33865;
}
});
...
reagent.impl.template.add_input_methods = (function add_input_methods(spec){var G__33867 = spec;(G__33867["componentDidUpdate"] = ((function (G__33867){
return (function (){var C = this;return reagent.impl.template.input_did_update.call(null,C);
});})(G__33867))
);
(G__33867["componentWillUnmount"] = ((function (G__33867){
...
return (function (p1__33868_SHARP_,p2__33869_SHARP_){var C = this;return reagent.impl.template.wrapped_should_update.call(null,C,p1__33868_SHARP_,p2__33869_SHARP_);
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__33871 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__33871,0,null);var id = cljs.core.nth.call(null,vec__33871,1,null);var class$ = cljs.core.nth.call(null,vec__33871,2,null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [comp,(cljs.core.truth_((function (){var or__3478__auto__ = id;if(cljs.core.truth_(or__3478__auto__))
{return or__3478__auto__;
} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__33873 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__33873,0,null);var id_class = cljs.core.nth.call(null,vec__33873,1,null);return reagent.impl.template.wrap_component.call(null,comp,id_class,[cljs.core.str(tag)].join(''));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,0));var jsprops = (function (){var obj33877 = {};(obj33877[reagent.impl.util.cljs_argv] = v);
(obj33877[reagent.impl.util.cljs_level] = level);
return obj33877;
})();var k_33878 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__33879 = (((k_33878 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,1,null)):k_33878);if((k_SINGLEQUOTE__33879 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__33879);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + 1);var n__4326__auto___33880 = a.length;var i_33881 = 0;while(true){
if((i_33881 < n__4326__auto___33880))
{(a[i_33881] = reagent.impl.template.as_component.call(null,(a[i_33881]),level_SINGLEQUOTE_));
{
var G__33882 = (i_33881 + 1);
i_33881 = G__33882;
continue;
}
} else
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__4326__auto___33883 = a.length;var i_33884 = 0;while(true){
if((i_33884 < n__4326__auto___33883))
{if((i_33884 >= first_child))
{(a[i_33884] = reagent.impl.template.as_component.call(null,(a[i_33884]),level));
} else
{}
{
