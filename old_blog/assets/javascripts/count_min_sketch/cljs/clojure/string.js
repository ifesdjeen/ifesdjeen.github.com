...
{{
var G__33811 = cljs.core.pop.call(null,v__$1);
v__$1 = G__33811;
continue;
}
} else
...
{var pred__33815 = cljs.core._EQ_;var expr__33816 = limit;if(cljs.core.truth_(pred__33815.call(null,1,expr__33816)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__33815.call(null,2,expr__33816)))
...
var G__33818 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__33819 = (limit__$1 - 1);
var G__33820 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__33818;
limit__$1 = G__33819;
parts = G__33820;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___33822 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___33822))
{var replacement_33823 = temp__4090__auto___33822;buffer.append([cljs.core.str(replacement_33823)].join(''));
} else
{buffer.append(ch);
}
{
var G__33824 = (index + 1);
index = G__33824;
continue;
}
}
