...
{return (function() { 
var G__6192__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__6195 = res;(G__6195[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__6195;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__6196){var vec__6198 = p__6196;var id = cljs.core.nth.call(null,vec__6198,0,null);var class$ = cljs.core.nth.call(null,vec__6198,1,null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_6199 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_6199 === "key")))
{(o[pname_6199] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__6202 = jsprops;(G__6202["defaultValue"] = value);
(G__6202["value"] = null);
(G__6202["onChange"] = ((function (G__6202,on_change,value){
return (function (p1__6200_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__6200_SHARP_);
});})(G__6202,on_change,value))
);
return G__6202;
}
});
...
reagent.impl.template.add_input_methods = (function add_input_methods(spec){var G__6204 = spec;(G__6204["componentDidUpdate"] = ((function (G__6204){
return (function (){var C = this;return reagent.impl.template.input_did_update.call(null,C);
});})(G__6204))
);
(G__6204["componentWillUnmount"] = ((function (G__6204){
...
return (function (p1__6205_SHARP_,p2__6206_SHARP_){var C = this;return reagent.impl.template.wrapped_should_update.call(null,C,p1__6205_SHARP_,p2__6206_SHARP_);
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__6208 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__6208,0,null);var id = cljs.core.nth.call(null,vec__6208,1,null);var class$ = cljs.core.nth.call(null,vec__6208,2,null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__6210 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__6210,0,null);var id_class = cljs.core.nth.call(null,vec__6210,1,null);return reagent.impl.template.wrap_component.call(null,comp,id_class,[cljs.core.str(tag)].join(''));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,0));var jsprops = (function (){var obj6214 = {};(obj6214[reagent.impl.util.cljs_argv] = v);
(obj6214[reagent.impl.util.cljs_level] = level);
return obj6214;
})();var k_6215 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__6216 = (((k_6215 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,1,null)):k_6215);if((k_SINGLEQUOTE__6216 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__6216);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + 1);var n__4326__auto___6217 = a.length;var i_6218 = 0;while(true){
if((i_6218 < n__4326__auto___6217))
{(a[i_6218] = reagent.impl.template.as_component.call(null,(a[i_6218]),level_SINGLEQUOTE_));
{
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__4326__auto___6220 = a.length;var i_6221 = 0;while(true){
if((i_6221 < n__4326__auto___6220))
{if((i_6221 >= first_child))
{(a[i_6221] = reagent.impl.template.as_component.call(null,(a[i_6221]),level));
} else
{}
{
