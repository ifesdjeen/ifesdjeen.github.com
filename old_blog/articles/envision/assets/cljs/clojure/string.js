...
{{
var G__6148 = cljs.core.pop.call(null,v__$1);
v__$1 = G__6148;
continue;
}
} else
...
{var pred__6152 = cljs.core._EQ_;var expr__6153 = limit;if(cljs.core.truth_(pred__6152.call(null,1,expr__6153)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__6152.call(null,2,expr__6153)))
...
var G__6155 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__6156 = (limit__$1 - 1);
var G__6157 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__6155;
limit__$1 = G__6156;
parts = G__6157;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___6159 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___6159))
{var replacement_6160 = temp__4090__auto___6159;buffer.append([cljs.core.str(replacement_6160)].join(''));
} else
{buffer.append(ch);
}
{
