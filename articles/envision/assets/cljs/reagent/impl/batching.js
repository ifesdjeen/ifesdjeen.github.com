...
{var C_6145 = (a[i]);if(cljs.core.truth_(C_6145.cljsIsDirty))
{C_6145.forceUpdate();
} else
{}
{
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_6147 = C.cljsRatom;if(!((ratom_6147 == null)))
{reagent.ratom.dispose_BANG_.call(null,ratom_6147);
} else
{}
