...
{var or__3478__auto____$1 = w.webkitRequestAnimationFrame;if(cljs.core.truth_(or__3478__auto____$1))
{return or__3478__auto____$1;
} else
{var or__3478__auto____$2 = w.mozRequestAnimationFrame;if(cljs.core.truth_(or__3478__auto____$2))
{return or__3478__auto____$2;
} else
{var or__3478__auto____$3 = w.msRequestAnimationFrame;if(cljs.core.truth_(or__3478__auto____$3))
...
var n__4326__auto__ = a.length;var i = 0;while(true){
if((i < n__4326__auto__))
{var C_33808 = (a[i]);if(cljs.core.truth_(C_33808.cljsIsDirty))
{C_33808.forceUpdate();
} else
{}
{
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__4045__auto__,writer__4046__auto__,opt__4047__auto__){return cljs.core._write.call(null,writer__4046__auto__,"reagent.impl.batching/RenderQueue");
});
...
reagent.impl.batching.is_reagent_component = (function is_reagent_component(C){var and__3466__auto__ = !((C == null));if(and__3466__auto__)
{var and__3466__auto____$1 = (C["props"]);if(cljs.core.truth_(and__3466__auto____$1))
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_33810 = C.cljsRatom;if(!((ratom_33810 == null)))
{reagent.ratom.dispose_BANG_.call(null,ratom_33810);
} else
{}
