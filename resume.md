...
### I-Play Search Website & Oberon Media Toolbar Website: I-play Search
  ...
  * Used Technologies: C#, ASP.NET MVC, MS SQL, NHibernate, JavaScript, Selenium WebDriver
...
### Oberon Media Gamecenter: Yahoo Games, MSN Games, Sweet IM, Gamenext
  ...
  * Used Technologies: Java, ATG, Hibernate, Spring, Scala, JavaScript, Oracle, MongoDB
...
### GetVouched: GetVouched
  ...
  * Used Technologies: JRuby on Rails, JavaScript (MooTools), Scala, Java, Hadoop, Postgre SQL, MongoDB, FlockDB, Solr.
...
### Vestify: Vestify
  ...
  * Used Technologies: Ruby on Rails, JavaScript (MooTools), Solr, Postgre SQL
...
### Verumax Device Portal: Dev version available at: VeruDev website (Credentials: test / test)
  ...
  * Used Technologies: Ruby on Rails, MySQL, JavaScript / ExtJS
...
### Central User Base:
  ...
  * Used Technologies: C#, WCF, JavaScript, Windows Services, WebSphere
